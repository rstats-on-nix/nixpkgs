...
let
  ...
  deriveCran = mkDerive {
    ...
    mkUrls = {name, version}: [
      "https://packagemanager.posit.co/cran/2022-01-01/src/contrib/${name}_${version}.tar.gz"
      "https://packagemanager.posit.co/cran/2022-01-01/src/contrib/Archive/${name}/${name}_${version}.tar.gz"
    ];
  };
