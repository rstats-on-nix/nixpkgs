let
 ...
 r_packages = builtins.attrValues {
  inherit (pkgs.rPackages) tidyverse data_table readxl fixest collapse rstanarm gdalcubes stars vapour quarto Rcpp terra geos devtools fledge fusen codetools jsonlite httr sys testthat knitr rmarkdown;
};
